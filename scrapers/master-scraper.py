...
ESPN_API_URL = "https://fantasy.espn.com/apis/v3/games/fba/seasons/2021/segments/0/leaguedefaults/1?view=kona_player_info"
        ...
        if len(td) == 0:
            ...
            if rank != "R#":
                ...
                for j in range(0, len(td)):
                    if td[j].find("span") != None and td[j].find("input") == None:
                ...
                if tip is not None:
                    formatted_data[len(formatted_data) - 1] = tip.text.strip()
